...
class TestQueryHandler:
    ...
    def test_get_all_currency_by_name(self, query_handler, database_with_data):
        assert query_handler.get_all_currency_by_name('btc-bitcoin').count() == 3
...
class TestDateHandler:
    ...
    def test_get_all_currency_by_name_between_dates(self, date_handler, database_with_data):
        assert date_handler.get_all_currency_by_name_between_dates(
...
class TestPriceHandler:
    ...
    def test_get_currency_prices_by_day(self, price_handler, query_handler, database_with_data):
        currency_data_class = query_handler.get_all_currency_by_name('btc-bitcoin').dicts()
        price_list = price_handler.get_currency_prices_by_day(currency_data_class)
